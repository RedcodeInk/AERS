...
import com.example.aers_global.databinding.FragmentInspectionBinding;
import com.example.aers_global.ui.finance.FinanceViewModel;

public class InspectionFragment extends Fragment {

    private FinanceViewModel InspectionViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.textInspection;
        InspectionViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
